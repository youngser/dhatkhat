...
Simply download [demo.R](http://www.cis.jhu.edu/~parky/dhatKhat/R/demo.R) and type
`source("demo.R")` in `R` prompt. Depending on a machine being used, it may take up to 10 minutes to run this demo.
